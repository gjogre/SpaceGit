...
public class SpaceEvent extends Event{
    ...
    @Override
        protected void init(){
            ...
            ship.setTexture("basicShip.png", 6f, 2f);
            ship.isLight = true;
    ...
    private void generatePlanets(){
            SpaceTexture solid = new SpaceTexture("planet.png",1f,1f);
            SpaceTexture gas = new SpaceTexture("gasplanet.png",1f,1f);
            SpaceTexture moon = new SpaceTexture("moon.png",1f,1f);
